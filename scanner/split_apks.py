# This module extracts and parses split APK ZIP files, identifies the base APK,
# and extracts all DEX bytecode files from the split bundle.
    ...
    for path, apk_obj in all_apks:
        ...
        for f in dex_filenames:
            try:
                ...
                logger.warning(f"Failed to parse DEX file {f} in {os.path.basename(path)}: {str(de)}")
    return dex_files
